...
test('e2e Content vocabulary meta-schema', function() {
    ...
    $schema = FluentSchema::make()
        ...
        ->type()->object()->type()->boolean()
        ->object()
        ->property('contentEncoding', FluentSchema::make()->type()->string()->return())
        ->property('contentMediaType', FluentSchema::make()->type()->string()->return())
...
test('e2e Format vocabulary meta-schema for annotation results', function() {
    ...
    $schema = FluentSchema::make()
        ...
        ->type()->object()->type()->boolean()
        ->object()
        ->property('format', FluentSchema::make()->type()->string()->return())
        ->return();
...
test('e2e Meta-data vocabulary meta-schema', function() {
    ...
    $schema = FluentSchema::make()
        ...
        ->property('examples', FluentSchema::make()
            ->type()->array()->items(FluentSchema::make()->true())->return()
        )
        ->return();
...
test('e2e Validation vocabulary meta-schema', function() {
    ...
    $schema = FluentSchema::make()
        ...
        ->def('stringArray', FluentSchema::make()
            ->type()->array()
            ->items(FluentSchema::make()->type()->string()->return())
            ->uniqueItems()
            ->return()
            ->default([])
        );
